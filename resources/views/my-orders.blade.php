...
@section('title', __('site.user_page.my_orders'))
...
>>>>>>> Stashed changes
        ...
        <span>{{ __('site.user_page.my_orders') }}</span>
    @endcomponent
    ...
    <div class="products-section my-orders container">
        ...
        <div class="my-profile">
            <div class="products-header">
                <h1 class="stylish-heading">{{ __('site.user_page.my_orders') }}</h1>
            </div>
            ...
            <div>
                ...
                <div class="order-container">
                    <div class="order-header">
                        ...
                        <div>
                            <div class="order-header-items">
                                <div><a href="{{ route('orders.show', $order->id) }}">{{__('site.user_page.order_details')}}</a></div>
                                <div>|</div>
